...
###############################################################################
#                                                                             #
#  post_process.pl - Script to process exported CSV file into almost any      #
#                    format.  Only modificaitons to the below variables are   #
#                    needed.                                                  #
#                                                                             #
###############################################################################
#                                                                             #
...
my $output_file = "export_example.csv";
...
my $output_format = [
	...
	{
		name => "Decription",
		data => "Bandwidth Charges - <<GraphTitle>>",
		quoted => 1,
		max_length => -1,
		fixed_length => -1,
		format => "%s"
