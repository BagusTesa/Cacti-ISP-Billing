...
###############################################################################
#                                                                             #
#  post_process_sql.pl - Script to process exported CSV file into sql insert  #
#                        statements for import into SQL database.             #
#                                                                             #
###############################################################################
#                                                                             #
#  Revision History                                                           #
...
my $output_file = "export_insert_example.sql";
...
my $output_format = [
	{
		name => "SQL",
		data => "INSERT INTO TABLE (`CustomerDescription`,`CustomerExternalId`,`BillingPeriodStart`,`BillingPeriodEnd`,`GraphTitle`,`GraphExternalId`,`Type`,`Interval`,`Every`,`RateType`,`RateAmount`,`RateUnit`,`Bits`,`Total`) VALUES (\'<<CustomerDescription>>\',\'<<CustomerExternalId>>\',\'<<BillingPeriodStart>>\',\'<<BillingPeriodEnd>>\',\'<<GraphTitle>>\',\'<<GraphExternalId>>\',\'<<Type>>\',\'<<Interval>>\',<<Every>>,\'<<RateType>>\',<<RateAmount>>,\'<<RateUnit>>\',<<Bits>>,<<Total>>);",
		quoted => 0,
		max_length => -1,
		fixed_length => -1,
		format => "%s"
